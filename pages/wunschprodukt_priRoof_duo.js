    ...
    <Layout>
      <Container>
        ...
        <p>
          ...
          <strong>priRoof Duo</strong> ist ab sofort für eine limitierte
        ...
        <Button href="https://priwatt.de/stecker-solaranlagen/schraegdach/priroof-duo/SW10080.127">
          Hier geht`s zum priRoof Duo!
        </Button>
        <p>
          Sollte dieser Button nicht angezeigt werden, klicke bitte{" "}
          <a href="https://priwatt.de/stecker-solaranlagen/schraegdach/priroof-duo/SW10080.127">
            hier
          </a>.
        </p>
        <p>
