    ...
    <Layout>
      <Container>
        ...
        <p>
          ...
          <strong>priWall</strong> ist ab sofort für eine limitierte
        ...
        <Button href="https://priwatt.de/stecker-solaranlagen/fassade/priwall/SW10043.106">
          Hier geht`s zum priWall!
        </Button>
        <p>
          Sollte dieser Button nicht angezeigt werden, klicke bitte{" "}
          <a href="https://priwatt.de/stecker-solaranlagen/fassade/priwall/SW10043.106">
            hier
          </a>.
        </p>
        <p>
