    ...
    <Layout>
      <Container>
        ...
        <p>
          ...
          <strong>priBasic Light Duo</strong> ist ab sofort für eine limitierte
        ...
        <Button href="https://priwatt.de/stecker-solaranlagen/basic/pribasic-light-duo/SW10087.43">
          Hier geht`s zum priBasic Light Duo!
        </Button>
        <p>
          Sollte dieser Button nicht angezeigt werden, klicke bitte{" "}
          <a href="https://priwatt.de/stecker-solaranlagen/basic/pribasic-light-duo/SW10087.43">
            hier
          </a>.
        </p>
        <p>
