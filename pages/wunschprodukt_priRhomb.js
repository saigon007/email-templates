    ...
    <Layout>
      <Container>
        ...
        <p>
          ...
          <strong>priRhomb</strong> ist ab sofort für eine limitierte
        ...
        <Button href="https://priwatt.de/stecker-solaranlagen/schraegdach/prirhomb/SW10044.106">
          Hier geht`s zum priRhomb!
        </Button>
        <p>
          Sollte dieser Button nicht angezeigt werden, klicke bitte{" "}
          <a href="https://priwatt.de/stecker-solaranlagen/schraegdach/prirhomb/SW10044.106">
            hier
          </a>.
        </p>
        <p>
