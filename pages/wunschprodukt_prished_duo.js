    ...
    <Layout>
      <Container>
        ...
        <p>
          ...
          <strong>priShed Duo</strong> ist ab sofort für eine limitierte
        ...
        <Button href="https://priwatt.de/stecker-solaranlagen/garten/prished-duo/SW10081.127">
          Hier geht`s zum priShed Duo!
        </Button>
        <p>
          Sollte dieser Button nicht angezeigt werden, klicke bitte{" "}
          <a href="https://priwatt.de/stecker-solaranlagen/garten/prished-duo/SW10081.127">
            hier
          </a>.
        </p>
        <p>
