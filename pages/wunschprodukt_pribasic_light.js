    ...
    <Layout>
      <Container>
        ...
        <p>
          ...
          <strong>priBasic Light</strong> ist ab sofort für eine limitierte
        ...
        <Button href="https://priwatt.de/stecker-solaranlagen/basic/pribasic-light-ohne-halterung/SW10055.106">
          Hier geht`s zum priBasic Light!
        </Button>
        <p>
          Sollte dieser Button nicht angezeigt werden, klicke bitte{" "}
          <a href="https://priwatt.de/stecker-solaranlagen/basic/pribasic-light-ohne-halterung/SW10055.106">
            hier
          </a>.
        </p>
        <p>
