    ...
    <Layout>
      <Container>
        ...
        <p>
          ...
          <strong>priWall Duo</strong> ist ab sofort für eine limitierte
        ...
        <Button href="https://priwatt.de/stecker-solaranlagen/fassade/priwall-duo/SW10086.127">
          Hier geht`s zum priBasic Light Duo!
        </Button>
        <p>
          Sollte dieser Button nicht angezeigt werden, klicke bitte{" "}
          <a href="https://priwatt.de/stecker-solaranlagen/fassade/priwall-duo/SW10086.127">
            hier
          </a>.
        </p>
        <p>
