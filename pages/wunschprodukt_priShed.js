    ...
    <Layout>
      <Container>
        ...
        <p>
          ...
          <strong>priShed</strong> ist ab sofort für eine limitierte
        ...
        <Button href="https://priwatt.de/stecker-solaranlagen/garten/prished/SW10049.106">
          Hier geht`s zum priShed!
        </Button>
        <p>
          Sollte dieser Button nicht angezeigt werden, klicke bitte{" "}
          <a href="https://priwatt.de/stecker-solaranlagen/garten/prished/SW10049.106">
            hier
          </a>.
        </p>
        <p>
