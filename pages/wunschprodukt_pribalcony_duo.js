    ...
    <Layout>
      <Container>
        ...
        <p>
          ...
          <strong>priBalcony Duo</strong> ist ab sofort für eine limitierte
        ...
        <Button href="https://priwatt.de/stecker-solaranlagen/balkon/pribalcony-duo/SW10076.127">
          Hier geht`s zum priBalcony Duo!
        </Button>
        <p>
          Sollte dieser Button nicht angezeigt werden, klicke bitte{" "}
          <a href="https://priwatt.de/stecker-solaranlagen/balkon/pribalcony-duo/SW10076.127">
            hier
          </a>.
        </p>
        <p>
