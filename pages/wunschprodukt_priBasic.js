    ...
    <Layout>
      <Container>
        ...
        <p>
          ...
          <strong>priBasic</strong> ist ab sofort für eine limitierte
        ...
        <Button href="https://priwatt.de/stecker-solaranlagen/basic/pribasic/SW10084.127">
          Hier geht`s zum priBasic!
        </Button>
        <p>
          Sollte dieser Button nicht angezeigt werden, klicke bitte{" "}
          <a href="https://priwatt.de/stecker-solaranlagen/basic/pribasic/SW10084.127">
            hier
          </a>.
        </p>
        <p>
