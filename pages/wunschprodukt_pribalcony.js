    ...
    <Layout>
      <Container>
        ...
        <p>
          ...
          <strong>priBalcony</strong> ist ab sofort für eine limitierte
        ...
        <Button href="https://priwatt.de/stecker-solaranlagen/balkon/pribalcony/SW10052.106">
          Hier geht`s zum priBalcony!
        </Button>
        <p>
          Sollte dieser Button nicht angezeigt werden, klicke bitte{" "}
          <a href="https://priwatt.de/stecker-solaranlagen/balkon/pribalcony/SW10052.106">
            hier
          </a>.
        </p>
        <p>
